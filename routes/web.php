...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/tara/{id}', [TaraController::class, 'index'])->name('tara.index');
...
// Routes related to Threat
    Route::get('/threat/{id}', [ThreatController::class, 'index'])->name('threat.index');
    ...
    Route::get('/damage/{id}', [DamageController::class, 'index'])->name('damage.index');
    ...
    Route::get('/main/{id}', [MainController::class, 'index'])->name('main.index');
